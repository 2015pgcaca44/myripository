...
<div class="grid_3">
  <div class="container">
   <div class="breadcrumb1">
     <ul>
        ...
        <li class="current-page">Create new Profile</li>
     </ul>
   </div>
   <div class="services">
 ...
 Date Of Birth <span class="form-required" title="This field is required.">*</span></label>
		    ...
		    <div class="form-group col-sm-2">
		      <label for="edit-name">This Profile is created by <span class="form-required" title="This field is required.">*</span></label>
			    <div class="select-block1">
